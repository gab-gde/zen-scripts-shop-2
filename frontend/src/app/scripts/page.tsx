...
const games = [
  ...
  { 
    name: 'NBA 2K25', 
    image: 'https://cdn.cloudflare.steamstatic.com/steam/apps/2688840/header.jpg',
    available: true
  },
  { 
    name: 'Rocket League', 
              ...
              >
                ...
                <div className="absolute bottom-0 left-0 right-0 p-3">
                  <div className="flex items-center justify-between gap-2">
                    <span className="font-bold text-sm md:text-base truncate">{game.name}</span>
                    {game.available ? (
                      <span className="bg-yellow-500/20 text-yellow-400 text-xs px-2 py-0.5 rounded-full whitespace-nowrap">Dispo</span>
                    ) : (
                      <span className="bg-gray-500/20 text-gray-400 text-xs px-2 py-0.5 rounded-full whitespace-nowrap">Bientôt</span>
                    )}
                  </div>
                </div>
              </div>
